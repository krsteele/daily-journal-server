...
class HandleRequests(BaseHTTPRequestHandler):
    def parse_url(self, path):
        ...
        # If the path is "/entries/1", the resulting list will
        # have "" at index 0, "entries" at index 1, and "1" at index 2.
    ...
    def do_GET(self):
        ...
        # which means the request was for `/entries` or `/entries/1`
        if len(parsed) == 2:
            (resource, id) = parsed
